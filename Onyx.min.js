...
function OnyxLtrRandom(place) {
    let rand = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'];
    const randElement = document.createElement('div');
    document.querySelector(place).appendChild(randElement);
    randElement.classList.add('onyx-lib-randomizer');
    randElement.innerHTML = rand[Math.floor(Math.random() * (rand.length))];
    randElement.style.fontFamily = 'Segoe UI';
}

// Gives a random number
function OnyxNumRandom(place) {
    let rand = [1, 2, 3, 4, 5, 6, 7, 8, 9];
    const randElement = document.createElement('div');
    document.querySelector(place).appendChild(randElement);
    randElement.classList.add('onyx-lib-randomizer');
    randElement.innerHTML = rand[Math.floor(Math.random() * (rand.length))];
